...
function Header({ ghost }: HeaderProps) {
  ...
  return (
    ...
    >
      <div className="border-stone-300 bg-white container fixed z-10 mx-auto inline-flex h-[72px] w-screen items-center justify-between rounded-[50px] border bg-opacity-10 p-4 backdrop-blur-2xl xl:w-[1280px]">
        <Menu />
      </div>
    </div>
  );
