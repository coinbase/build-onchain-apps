...
function MemoCard({ userName, message, time }: CoffeeMemo) {
  ...
  return (
    <div className="border-zinc-700 bg-zinc-900 rounded-xl border border-solid p-3">
      <div className="flex justify-start gap-3">
        <div className="flex items-center justify-between gap-3">
          <div className="relative inline-flex h-10 w-10">
            <span className="bg-gray-800 flex h-full w-full items-center justify-center rounded-full">
              <span className="text-gray-700 dark:text-gray-400 text-sm font-medium uppercase">
                {userName[0]}
              </span>
            </span>
          </div>
