...
import AccountAbstraction from '.';
...
export const metadata = generateMetadata({
  ...
  images: 'themes.png',
  pathname: 'account-abstraction',
});

/**
 * Server component, which imports the AccountAbstraction component (client component that has 'use client' in it)
