...
export default function Introduction() {
  ...
  return (
    <section>
      <div className="mx-[-100vw] my-10 md:my-16 h-px bg-zinc-400 bg-opacity-20" />
      <div className="flex flex-col md:flex-row md:items-center justify-start gap-8">
        <Image alt="user-avatar" src={UserAvatar} className='w-28 h-28'/>
        <div className="flex flex-col items-start justify-start gap-2">
          <div className="w-96 text-3xl font-semibold text-white">{userName}</div>
          <div className="text-base font-normal leading-normal text-zinc-400">
            {aboutUser}
          </div>
