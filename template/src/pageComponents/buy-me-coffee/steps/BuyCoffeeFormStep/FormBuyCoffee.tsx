...
type FormBuyCoffeeProps = {
  ...
  refetchMemos: (options?: RefetchOptions | undefined) => Promise<QueryObserverResult<readonly {
    numCoffees: bigint;
    userName: string;
...
function FormBuyCoffee({
  ...
  }, [dataHash, errorBuyMeACoffee, handleOncomplete, setTransactionStep, statusBuyMeACoffee, transactionStatus]);
  ...
  return (
    <>
      {transactionStep === TransactionSteps.START_TRANSACTION_STEP && (
