...
import { NUMBER_OF_COFFEES, BUY_COFFEE_AMOUNT_RAW } from './consts';
import { WarningContent } from './WarningContent';

export type FormBuyCoffeeProps = {
...
export default function FormBuyCoffee({
  setTransactionStep,
  numCoffees,
  setNumCoffees,
  refetchMemos,
  ...
  console.log('omg transactionStatus', { transactionStatus, contract, buyCoffeeData });

  useEffect(() => {
    console.log('omg useEffect', { transactionStatus, dataHash });
  ...
  const handleSubmit = useCallback(() => {
    console.log('omg handleSubmit', buyCoffeeData, dataBuyMeACoffee);
  ...
  }, [buyMeACoffee, dataBuyMeACoffee, setTransactionStep, buyCoffeeData]);
    ...
    <>
      ...
      <form onSubmit={handleSubmit} className="w-full">
        ...
        <div>
          ...
          <WarningContent canAfford={canAfford} contract={contract} />
